...
func (o *EdgeCacheRule) GetAllowedMethods() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *EdgeCacheRule) GetAllowedMethodsOk() (*interface{}, bool) {
...
func (o *EdgeCacheRule) SetAllowedMethods(v interface{}) {
	o.AllowedMethods = v
}
