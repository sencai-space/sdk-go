...
// checks if the CreateCogsRecordRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCogsRecordRequestData{}

// CreateCogsRecordRequestData struct for CreateCogsRecordRequestData
type CreateCogsRecordRequestData struct {
...
type _CreateCogsRecordRequestData CreateCogsRecordRequestData

// NewCreateCogsRecordRequestData instantiates a new CreateCogsRecordRequestData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateCogsRecordRequestData(orgDocId string, periodStart time.Time, periodEnd time.Time, organisation CreateAccessReviewRequestDataReviewer) *CreateCogsRecordRequestData {
	this := CreateCogsRecordRequestData{}
...
// NewCreateCogsRecordRequestDataWithDefaults instantiates a new CreateCogsRecordRequestData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCreateCogsRecordRequestDataWithDefaults() *CreateCogsRecordRequestData {
	this := CreateCogsRecordRequestData{}
	return &this
}

// GetOrgDocId returns the OrgDocId field value
func (o *CreateCogsRecordRequestData) GetOrgDocId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CreateCogsRecordRequestData) GetOrgDocIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) SetOrgDocId(v string) {
	o.OrgDocId = v
}

// GetPeriodStart returns the PeriodStart field value
func (o *CreateCogsRecordRequestData) GetPeriodStart() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetPeriodStartOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) SetPeriodStart(v time.Time) {
	o.PeriodStart = v
}

// GetPeriodEnd returns the PeriodEnd field value
func (o *CreateCogsRecordRequestData) GetPeriodEnd() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetPeriodEndOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) SetPeriodEnd(v time.Time) {
	o.PeriodEnd = v
}

// GetPeriodType returns the PeriodType field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetPeriodType() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetPeriodTypeOk() (*string, bool) {
	if o == nil || IsNil(o.PeriodType) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasPeriodType() bool {
	if o != nil && !IsNil(o.PeriodType) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetPeriodType(v string) {
	o.PeriodType = &v
}

// GetProviderId returns the ProviderId field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetProviderId() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetProviderIdOk() (*string, bool) {
	if o == nil || IsNil(o.ProviderId) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasProviderId() bool {
	if o != nil && !IsNil(o.ProviderId) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetProviderId(v string) {
	o.ProviderId = &v
}

// GetServiceCategory returns the ServiceCategory field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetServiceCategory() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetServiceCategoryOk() (*string, bool) {
	if o == nil || IsNil(o.ServiceCategory) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasServiceCategory() bool {
	if o != nil && !IsNil(o.ServiceCategory) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetServiceCategory(v string) {
	o.ServiceCategory = &v
}

// GetBilledCost returns the BilledCost field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetBilledCost() float32 {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetBilledCostOk() (*float32, bool) {
	if o == nil || IsNil(o.BilledCost) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasBilledCost() bool {
	if o != nil && !IsNil(o.BilledCost) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetBilledCost(v float32) {
	o.BilledCost = &v
}

// GetEffectiveCost returns the EffectiveCost field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetEffectiveCost() float32 {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetEffectiveCostOk() (*float32, bool) {
	if o == nil || IsNil(o.EffectiveCost) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasEffectiveCost() bool {
	if o != nil && !IsNil(o.EffectiveCost) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetEffectiveCost(v float32) {
	o.EffectiveCost = &v
}

// GetCurrency returns the Currency field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetCurrency() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetCurrencyOk() (*string, bool) {
	if o == nil || IsNil(o.Currency) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetCurrency(v string) {
	o.Currency = &v
}

// GetManagedHosts returns the ManagedHosts field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetManagedHosts() int32 {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetManagedHostsOk() (*int32, bool) {
	if o == nil || IsNil(o.ManagedHosts) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasManagedHosts() bool {
	if o != nil && !IsNil(o.ManagedHosts) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetManagedHosts(v int32) {
	o.ManagedHosts = &v
}

// GetLlmTokenCostUsd returns the LlmTokenCostUsd field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetLlmTokenCostUsd() float32 {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetLlmTokenCostUsdOk() (*float32, bool) {
	if o == nil || IsNil(o.LlmTokenCostUsd) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasLlmTokenCostUsd() bool {
	if o != nil && !IsNil(o.LlmTokenCostUsd) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetLlmTokenCostUsd(v float32) {
	o.LlmTokenCostUsd = &v
}

// GetLlmTokensTotal returns the LlmTokensTotal field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetLlmTokensTotal() int32 {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetLlmTokensTotalOk() (*int32, bool) {
	if o == nil || IsNil(o.LlmTokensTotal) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasLlmTokensTotal() bool {
	if o != nil && !IsNil(o.LlmTokensTotal) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetLlmTokensTotal(v int32) {
	o.LlmTokensTotal = &v
}

// GetCloudComputeCostUsd returns the CloudComputeCostUsd field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetCloudComputeCostUsd() float32 {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetCloudComputeCostUsdOk() (*float32, bool) {
	if o == nil || IsNil(o.CloudComputeCostUsd) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasCloudComputeCostUsd() bool {
	if o != nil && !IsNil(o.CloudComputeCostUsd) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetCloudComputeCostUsd(v float32) {
	o.CloudComputeCostUsd = &v
}

// GetFocusVersion returns the FocusVersion field value if set, zero value otherwise.
func (o *CreateCogsRecordRequestData) GetFocusVersion() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetFocusVersionOk() (*string, bool) {
	if o == nil || IsNil(o.FocusVersion) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasFocusVersion() bool {
	if o != nil && !IsNil(o.FocusVersion) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetFocusVersion(v string) {
	o.FocusVersion = &v
}
...
func (o *CreateCogsRecordRequestData) HasTags() bool {
	if o != nil && !IsNil(o.Tags) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) GetIdempotencyKey() string {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetIdempotencyKeyOk() (*string, bool) {
	if o == nil || IsNil(o.IdempotencyKey) {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) HasIdempotencyKey() bool {
	if o != nil && !IsNil(o.IdempotencyKey) {
		return true
	}
...
func (o *CreateCogsRecordRequestData) SetIdempotencyKey(v string) {
	o.IdempotencyKey = &v
}

// GetOrganisation returns the Organisation field value
func (o *CreateCogsRecordRequestData) GetOrganisation() CreateAccessReviewRequestDataReviewer {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateCogsRecordRequestData) GetOrganisationOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateCogsRecordRequestData) SetOrganisation(v CreateAccessReviewRequestDataReviewer) {
	o.Organisation = v
}

func (o CreateCogsRecordRequestData) MarshalJSON() ([]byte, error) {
...
func (o CreateCogsRecordRequestData) ToMap() (map[string]interface{}, error) {
...
func (o *CreateCogsRecordRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCogsRecordRequestData := _CreateCogsRecordRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCogsRecordRequestData)

	if err != nil {
		return err
	}

	*o = CreateCogsRecordRequestData(varCreateCogsRecordRequestData)

	return err
}

type NullableCreateCogsRecordRequestData struct {
	value *CreateCogsRecordRequestData
	isSet bool
}

func (v NullableCreateCogsRecordRequestData) Get() *CreateCogsRecordRequestData {
	return v.value
}

func (v *NullableCreateCogsRecordRequestData) Set(val *CreateCogsRecordRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCogsRecordRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCogsRecordRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCogsRecordRequestData(val *CreateCogsRecordRequestData) *NullableCreateCogsRecordRequestData {
	return &NullableCreateCogsRecordRequestData{value: val, isSet: true}
}

func (v NullableCreateCogsRecordRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCogsRecordRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
