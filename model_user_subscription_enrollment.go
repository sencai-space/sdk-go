...
// checks if the UserSubscriptionEnrollment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSubscriptionEnrollment{}

// UserSubscriptionEnrollment struct for UserSubscriptionEnrollment
type UserSubscriptionEnrollment struct {
...
type _UserSubscriptionEnrollment UserSubscriptionEnrollment

// NewUserSubscriptionEnrollment instantiates a new UserSubscriptionEnrollment object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUserSubscriptionEnrollment(user CreateAccessReviewRequestDataReviewer, status string) *UserSubscriptionEnrollment {
	this := UserSubscriptionEnrollment{}
	this.User = user
	this.Status = status
	return &this
}

// NewUserSubscriptionEnrollmentWithDefaults instantiates a new UserSubscriptionEnrollment object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUserSubscriptionEnrollmentWithDefaults() *UserSubscriptionEnrollment {
	this := UserSubscriptionEnrollment{}
	return &this
}

// GetUser returns the User field value
func (o *UserSubscriptionEnrollment) GetUser() CreateAccessReviewRequestDataReviewer {
	if o == nil {
...
func (o *UserSubscriptionEnrollment) GetUserOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil {
		return nil, false
	}
	return &o.User, true
...
func (o *UserSubscriptionEnrollment) SetUser(v CreateAccessReviewRequestDataReviewer) {
	o.User = v
}

// GetPlan returns the Plan field value if set, zero value otherwise.
func (o *UserSubscriptionEnrollment) GetPlan() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetPlanOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.Plan) {
		return nil, false
	}
	return o.Plan, true
...
func (o *UserSubscriptionEnrollment) HasPlan() bool {
	if o != nil && !IsNil(o.Plan) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetPlan(v CreateAccessReviewRequestDataReviewer) {
	o.Plan = &v
}

// GetStatus returns the Status field value
func (o *UserSubscriptionEnrollment) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) SetStatus(v string) {
	o.Status = v
}

// GetStartedAt returns the StartedAt field value if set, zero value otherwise.
func (o *UserSubscriptionEnrollment) GetStartedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetStartedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.StartedAt) {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) HasStartedAt() bool {
	if o != nil && !IsNil(o.StartedAt) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetStartedAt(v time.Time) {
	o.StartedAt = &v
}

// GetTrialEndsAt returns the TrialEndsAt field value if set, zero value otherwise.
func (o *UserSubscriptionEnrollment) GetTrialEndsAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetTrialEndsAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.TrialEndsAt) {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) HasTrialEndsAt() bool {
	if o != nil && !IsNil(o.TrialEndsAt) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetTrialEndsAt(v time.Time) {
	o.TrialEndsAt = &v
}

// GetExpiresAt returns the ExpiresAt field value if set, zero value otherwise.
func (o *UserSubscriptionEnrollment) GetExpiresAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetExpiresAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.ExpiresAt) {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) HasExpiresAt() bool {
	if o != nil && !IsNil(o.ExpiresAt) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetExpiresAt(v time.Time) {
	o.ExpiresAt = &v
}

// GetSponsor returns the Sponsor field value if set, zero value otherwise.
func (o *UserSubscriptionEnrollment) GetSponsor() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetSponsorOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.Sponsor) {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) HasSponsor() bool {
	if o != nil && !IsNil(o.Sponsor) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetSponsor(v CreateAccessReviewRequestDataReviewer) {
	o.Sponsor = &v
}

// GetStripeCustomerId returns the StripeCustomerId field value if set, zero value otherwise.
func (o *UserSubscriptionEnrollment) GetStripeCustomerId() string {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetStripeCustomerIdOk() (*string, bool) {
	if o == nil || IsNil(o.StripeCustomerId) {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) HasStripeCustomerId() bool {
	if o != nil && !IsNil(o.StripeCustomerId) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetStripeCustomerId(v string) {
	o.StripeCustomerId = &v
}

// GetStripeSubscriptionId returns the StripeSubscriptionId field value if set, zero value otherwise.
func (o *UserSubscriptionEnrollment) GetStripeSubscriptionId() string {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetStripeSubscriptionIdOk() (*string, bool) {
	if o == nil || IsNil(o.StripeSubscriptionId) {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) HasStripeSubscriptionId() bool {
	if o != nil && !IsNil(o.StripeSubscriptionId) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetStripeSubscriptionId(v string) {
...
func (o *UserSubscriptionEnrollment) GetSponsorshipInvitationToken() string {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetSponsorshipInvitationTokenOk() (*string, bool) {
	if o == nil || IsNil(o.SponsorshipInvitationToken) {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) HasSponsorshipInvitationToken() bool {
	if o != nil && !IsNil(o.SponsorshipInvitationToken) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetSponsorshipInvitationToken(v string) {
...
func (o *UserSubscriptionEnrollment) HasPendingSponsorship() bool {
	if o != nil && !IsNil(o.PendingSponsorship) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) GetSponsorshipStripeItemId() string {
...
// and a boolean to check if the value has been set.
func (o *UserSubscriptionEnrollment) GetSponsorshipStripeItemIdOk() (*string, bool) {
	if o == nil || IsNil(o.SponsorshipStripeItemId) {
		return nil, false
	}
...
func (o *UserSubscriptionEnrollment) HasSponsorshipStripeItemId() bool {
	if o != nil && !IsNil(o.SponsorshipStripeItemId) {
		return true
	}
...
func (o *UserSubscriptionEnrollment) SetSponsorshipStripeItemId(v string) {
	o.SponsorshipStripeItemId = &v
}

func (o UserSubscriptionEnrollment) MarshalJSON() ([]byte, error) {
...
func (o UserSubscriptionEnrollment) ToMap() (map[string]interface{}, error) {
...
func (o *UserSubscriptionEnrollment) UnmarshalJSON(data []byte) (err error) {
	...
	varUserSubscriptionEnrollment := _UserSubscriptionEnrollment{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserSubscriptionEnrollment)

	if err != nil {
		return err
	}

	*o = UserSubscriptionEnrollment(varUserSubscriptionEnrollment)

	return err
}

type NullableUserSubscriptionEnrollment struct {
	value *UserSubscriptionEnrollment
	isSet bool
}

func (v NullableUserSubscriptionEnrollment) Get() *UserSubscriptionEnrollment {
	return v.value
}

func (v *NullableUserSubscriptionEnrollment) Set(val *UserSubscriptionEnrollment) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSubscriptionEnrollment) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSubscriptionEnrollment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSubscriptionEnrollment(val *UserSubscriptionEnrollment) *NullableUserSubscriptionEnrollment {
	return &NullableUserSubscriptionEnrollment{value: val, isSet: true}
}

func (v NullableUserSubscriptionEnrollment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserSubscriptionEnrollment) UnmarshalJSON(src []byte) error {
	v.isSet = true
