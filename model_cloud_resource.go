...
// checks if the CloudResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudResource{}
...
type _CloudResource CloudResource

// NewCloudResource instantiates a new CloudResource object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCloudResource(name string, kind string, provider string, region string, status string, currency string, homeRegion string) *CloudResource {
	this := CloudResource{}
	this.Name = name
	this.Kind = kind
...
func (o *CloudResource) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CloudResource) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *CloudResource) SetName(v string) {
	o.Name = v
}
...
func (o *CloudResource) GetServiceType() string {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetServiceTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ServiceType) {
		return nil, false
	}
...
func (o *CloudResource) HasServiceType() bool {
	if o != nil && !IsNil(o.ServiceType) {
		return true
	}
...
func (o *CloudResource) SetServiceType(v string) {
	o.ServiceType = &v
}

// GetProvider returns the Provider field value
func (o *CloudResource) GetProvider() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetProviderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CloudResource) SetProvider(v string) {
	o.Provider = v
}

// GetRegion returns the Region field value
func (o *CloudResource) GetRegion() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetRegionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CloudResource) SetRegion(v string) {
	o.Region = v
}

// GetStatus returns the Status field value
func (o *CloudResource) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CloudResource) SetStatus(v string) {
	o.Status = v
}

// GetExternalId returns the ExternalId field value if set, zero value otherwise.
func (o *CloudResource) GetExternalId() string {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetExternalIdOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalId) {
		return nil, false
	}
...
func (o *CloudResource) HasExternalId() bool {
	if o != nil && !IsNil(o.ExternalId) {
		return true
	}
...
func (o *CloudResource) SetExternalId(v string) {
	o.ExternalId = &v
}
...
func (o *CloudResource) HasSpec() bool {
	if o != nil && !IsNil(o.Spec) {
		return true
	}
...
func (o *CloudResource) HasOutputs() bool {
	if o != nil && !IsNil(o.Outputs) {
		return true
	}
...
func (o *CloudResource) GetEndpoint() string {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetEndpointOk() (*string, bool) {
	if o == nil || IsNil(o.Endpoint) {
		return nil, false
	}
...
func (o *CloudResource) HasEndpoint() bool {
	if o != nil && !IsNil(o.Endpoint) {
		return true
	}
...
func (o *CloudResource) SetEndpoint(v string) {
	o.Endpoint = &v
}

// GetConnectionSecret returns the ConnectionSecret field value if set, zero value otherwise.
func (o *CloudResource) GetConnectionSecret() string {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetConnectionSecretOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectionSecret) {
		return nil, false
	}
...
func (o *CloudResource) HasConnectionSecret() bool {
	if o != nil && !IsNil(o.ConnectionSecret) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetMonthlyCostOk() (*float32, bool) {
	if o == nil || IsNil(o.MonthlyCost) {
		return nil, false
	}
...
func (o *CloudResource) HasMonthlyCost() bool {
	if o != nil && !IsNil(o.MonthlyCost) {
		return true
	}
...
func (o *CloudResource) SetMonthlyCost(v float32) {
	o.MonthlyCost = &v
}

// GetCurrency returns the Currency field value
func (o *CloudResource) GetCurrency() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetCurrencyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CloudResource) SetCurrency(v string) {
	o.Currency = v
}

// GetErrorMessage returns the ErrorMessage field value if set, zero value otherwise.
func (o *CloudResource) GetErrorMessage() string {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetErrorMessageOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorMessage) {
		return nil, false
	}
...
func (o *CloudResource) HasErrorMessage() bool {
	if o != nil && !IsNil(o.ErrorMessage) {
		return true
	}
...
func (o *CloudResource) SetErrorMessage(v string) {
	o.ErrorMessage = &v
}

// GetProvisionedAt returns the ProvisionedAt field value if set, zero value otherwise.
func (o *CloudResource) GetProvisionedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetProvisionedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.ProvisionedAt) {
		return nil, false
	}
...
func (o *CloudResource) HasProvisionedAt() bool {
	if o != nil && !IsNil(o.ProvisionedAt) {
		return true
	}
...
func (o *CloudResource) SetProvisionedAt(v time.Time) {
	o.ProvisionedAt = &v
}

// GetTerminatedAt returns the TerminatedAt field value if set, zero value otherwise.
func (o *CloudResource) GetTerminatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetTerminatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.TerminatedAt) {
		return nil, false
	}
...
func (o *CloudResource) HasTerminatedAt() bool {
	if o != nil && !IsNil(o.TerminatedAt) {
		return true
	}
...
func (o *CloudResource) SetTerminatedAt(v time.Time) {
	o.TerminatedAt = &v
}
...
func (o *CloudResource) HasMetadata() bool {
	if o != nil && !IsNil(o.Metadata) {
		return true
	}
...
func (o *CloudResource) GetOrganisation() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetOrganisationOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.Organisation) {
		return nil, false
	}
...
func (o *CloudResource) HasOrganisation() bool {
	if o != nil && !IsNil(o.Organisation) {
		return true
	}
...
func (o *CloudResource) SetOrganisation(v CreateAccessReviewRequestDataReviewer) {
	o.Organisation = &v
}

// GetCreatedByUser returns the CreatedByUser field value if set, zero value otherwise.
func (o *CloudResource) GetCreatedByUser() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetCreatedByUserOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.CreatedByUser) {
		return nil, false
	}
...
func (o *CloudResource) HasCreatedByUser() bool {
	if o != nil && !IsNil(o.CreatedByUser) {
		return true
	}
...
func (o *CloudResource) SetCreatedByUser(v CreateAccessReviewRequestDataReviewer) {
	o.CreatedByUser = &v
}

// GetCredential returns the Credential field value if set, zero value otherwise.
func (o *CloudResource) GetCredential() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetCredentialOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.Credential) {
		return nil, false
	}
...
func (o *CloudResource) HasCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *CloudResource) SetCredential(v CreateAccessReviewRequestDataReviewer) {
	o.Credential = &v
}

// GetCloudInstance returns the CloudInstance field value if set, zero value otherwise.
func (o *CloudResource) GetCloudInstance() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetCloudInstanceOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.CloudInstance) {
		return nil, false
	}
...
func (o *CloudResource) HasCloudInstance() bool {
	if o != nil && !IsNil(o.CloudInstance) {
		return true
	}
...
func (o *CloudResource) SetCloudInstance(v CreateAccessReviewRequestDataReviewer) {
	o.CloudInstance = &v
}

// GetHomeRegion returns the HomeRegion field value
func (o *CloudResource) GetHomeRegion() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetHomeRegionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CloudResource) SetHomeRegion(v string) {
	o.HomeRegion = v
}

// GetCellId returns the CellId field value if set, zero value otherwise.
func (o *CloudResource) GetCellId() string {
...
// and a boolean to check if the value has been set.
func (o *CloudResource) GetCellIdOk() (*string, bool) {
	if o == nil || IsNil(o.CellId) {
		return nil, false
	}
...
func (o *CloudResource) HasCellId() bool {
	if o != nil && !IsNil(o.CellId) {
		return true
	}
...
func (o *CloudResource) SetCellId(v string) {
	o.CellId = &v
}
...
func (o CloudResource) ToMap() (map[string]interface{}, error) {
...
func (o *CloudResource) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudResource := _CloudResource{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCloudResource)

	if err != nil {
		return err
	}

	*o = CloudResource(varCloudResource)
