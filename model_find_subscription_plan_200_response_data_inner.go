...
var _ MappedNullable = &FindSubscriptionPlan200ResponseDataInner{}
...
// NewFindSubscriptionPlan200ResponseDataInnerWithDefaults instantiates a new FindSubscriptionPlan200ResponseDataInner object
...
func (o *FindSubscriptionPlan200ResponseDataInner) GetDocumentId() string {
...
// and a boolean to check if the value has been set.
func (o *FindSubscriptionPlan200ResponseDataInner) GetDocumentIdOk() (*string, bool) {
	if o == nil || IsNil(o.DocumentId) {
		return nil, false
	}
...
func (o *FindSubscriptionPlan200ResponseDataInner) HasDocumentId() bool {
	if o != nil && !IsNil(o.DocumentId) {
		return true
	}
...
func (o *FindSubscriptionPlan200ResponseDataInner) SetDocumentId(v string) {
	o.DocumentId = &v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *FindSubscriptionPlan200ResponseDataInner) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FindSubscriptionPlan200ResponseDataInner) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *FindSubscriptionPlan200ResponseDataInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *FindSubscriptionPlan200ResponseDataInner) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *FindSubscriptionPlan200ResponseDataInner) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *FindSubscriptionPlan200ResponseDataInner) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *FindSubscriptionPlan200ResponseDataInner) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

// GetUpdatedAt returns the UpdatedAt field value if set, zero value otherwise.
func (o *FindSubscriptionPlan200ResponseDataInner) GetUpdatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *FindSubscriptionPlan200ResponseDataInner) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.UpdatedAt) {
		return nil, false
	}
...
func (o *FindSubscriptionPlan200ResponseDataInner) HasUpdatedAt() bool {
	if o != nil && !IsNil(o.UpdatedAt) {
		return true
	}
...
func (o *FindSubscriptionPlan200ResponseDataInner) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = &v
}

// GetPublishedAt returns the PublishedAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FindSubscriptionPlan200ResponseDataInner) GetPublishedAt() time.Time {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *FindSubscriptionPlan200ResponseDataInner) GetPublishedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FindSubscriptionPlan200ResponseDataInner) HasPublishedAt() bool {
...
func (o *FindSubscriptionPlan200ResponseDataInner) SetPublishedAt(v time.Time) {
	o.PublishedAt.Set(&v)
}
// SetPublishedAtNil sets the value for PublishedAt to be an explicit nil
func (o *FindSubscriptionPlan200ResponseDataInner) SetPublishedAtNil() {
	o.PublishedAt.Set(nil)
}

// UnsetPublishedAt ensures that no value is present for PublishedAt, not even an explicit nil
func (o *FindSubscriptionPlan200ResponseDataInner) UnsetPublishedAt() {
	o.PublishedAt.Unset()
}

func (o FindSubscriptionPlan200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableFindSubscriptionPlan200ResponseDataInner struct {
	value *FindSubscriptionPlan200ResponseDataInner
	isSet bool
}

func (v NullableFindSubscriptionPlan200ResponseDataInner) Get() *FindSubscriptionPlan200ResponseDataInner {
	return v.value
}

func (v *NullableFindSubscriptionPlan200ResponseDataInner) Set(val *FindSubscriptionPlan200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFindSubscriptionPlan200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFindSubscriptionPlan200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindSubscriptionPlan200ResponseDataInner(val *FindSubscriptionPlan200ResponseDataInner) *NullableFindSubscriptionPlan200ResponseDataInner {
	return &NullableFindSubscriptionPlan200ResponseDataInner{value: val, isSet: true}
}

func (v NullableFindSubscriptionPlan200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindSubscriptionPlan200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
