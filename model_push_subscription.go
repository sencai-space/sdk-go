...
func (o *PushSubscription) GetEventFilters() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *PushSubscription) GetEventFiltersOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.EventFilters) {
...
func (o *PushSubscription) SetEventFilters(v map[string]interface{}) {
	o.EventFilters = v
}
