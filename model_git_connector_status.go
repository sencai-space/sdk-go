...
// checks if the GitConnectorStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GitConnectorStatus{}

// GitConnectorStatus struct for GitConnectorStatus
...
type _GitConnectorStatus GitConnectorStatus

// NewGitConnectorStatus instantiates a new GitConnectorStatus object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGitConnectorStatus(instanceId string) *GitConnectorStatus {
	this := GitConnectorStatus{}
	this.InstanceId = instanceId
	return &this
}

// NewGitConnectorStatusWithDefaults instantiates a new GitConnectorStatus object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGitConnectorStatusWithDefaults() *GitConnectorStatus {
	this := GitConnectorStatus{}
	return &this
}

// GetInstanceId returns the InstanceId field value
func (o *GitConnectorStatus) GetInstanceId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GitConnectorStatus) GetInstanceIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GitConnectorStatus) SetInstanceId(v string) {
	o.InstanceId = v
}

// GetGitstatus returns the Gitstatus field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetGitstatus() string {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetGitstatusOk() (*string, bool) {
	if o == nil || IsNil(o.Gitstatus) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasGitstatus() bool {
	if o != nil && !IsNil(o.Gitstatus) {
		return true
	}
...
func (o *GitConnectorStatus) SetGitstatus(v string) {
	o.Gitstatus = &v
}

// GetLastHeartbeat returns the LastHeartbeat field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetLastHeartbeat() time.Time {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetLastHeartbeatOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastHeartbeat) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasLastHeartbeat() bool {
	if o != nil && !IsNil(o.LastHeartbeat) {
		return true
	}
...
func (o *GitConnectorStatus) SetLastHeartbeat(v time.Time) {
	o.LastHeartbeat = &v
}

// GetUptime returns the Uptime field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetUptime() int32 {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetUptimeOk() (*int32, bool) {
	if o == nil || IsNil(o.Uptime) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasUptime() bool {
	if o != nil && !IsNil(o.Uptime) {
		return true
	}
...
func (o *GitConnectorStatus) SetUptime(v int32) {
	o.Uptime = &v
}

// GetVersion returns the Version field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetVersion() string {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetVersionOk() (*string, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *GitConnectorStatus) SetVersion(v string) {
	o.Version = &v
}

// GetToolboxStatus returns the ToolboxStatus field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetToolboxStatus() string {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetToolboxStatusOk() (*string, bool) {
	if o == nil || IsNil(o.ToolboxStatus) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasToolboxStatus() bool {
	if o != nil && !IsNil(o.ToolboxStatus) {
		return true
	}
...
func (o *GitConnectorStatus) SetToolboxStatus(v string) {
	o.ToolboxStatus = &v
}

// GetAppsStatus returns the AppsStatus field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetAppsStatus() string {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetAppsStatusOk() (*string, bool) {
	if o == nil || IsNil(o.AppsStatus) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasAppsStatus() bool {
	if o != nil && !IsNil(o.AppsStatus) {
		return true
	}
...
func (o *GitConnectorStatus) SetAppsStatus(v string) {
	o.AppsStatus = &v
}

// GetTotalRepositories returns the TotalRepositories field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetTotalRepositories() int32 {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetTotalRepositoriesOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalRepositories) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasTotalRepositories() bool {
	if o != nil && !IsNil(o.TotalRepositories) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetToolboxRepositoriesOk() (*int32, bool) {
	if o == nil || IsNil(o.ToolboxRepositories) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasToolboxRepositories() bool {
	if o != nil && !IsNil(o.ToolboxRepositories) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetAppsRepositoriesOk() (*int32, bool) {
	if o == nil || IsNil(o.AppsRepositories) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasAppsRepositories() bool {
	if o != nil && !IsNil(o.AppsRepositories) {
		return true
	}
...
func (o *GitConnectorStatus) SetAppsRepositories(v int32) {
	o.AppsRepositories = &v
}

// GetLastSyncDate returns the LastSyncDate field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetLastSyncDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetLastSyncDateOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastSyncDate) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasLastSyncDate() bool {
	if o != nil && !IsNil(o.LastSyncDate) {
		return true
	}
...
func (o *GitConnectorStatus) SetLastSyncDate(v time.Time) {
	o.LastSyncDate = &v
}

// GetLastError returns the LastError field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetLastError() string {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetLastErrorOk() (*string, bool) {
	if o == nil || IsNil(o.LastError) {
		return nil, false
	}
...
func (o *GitConnectorStatus) HasLastError() bool {
	if o != nil && !IsNil(o.LastError) {
		return true
	}
...
func (o *GitConnectorStatus) SetLastError(v string) {
	o.LastError = &v
}

// GetMetadata returns the Metadata field value if set, zero value otherwise.
func (o *GitConnectorStatus) GetMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *GitConnectorStatus) GetMetadataOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Metadata) {
...
func (o *GitConnectorStatus) HasMetadata() bool {
	if o != nil && !IsNil(o.Metadata) {
		return true
	}
...
func (o *GitConnectorStatus) SetMetadata(v map[string]interface{}) {
	o.Metadata = v
}

func (o GitConnectorStatus) MarshalJSON() ([]byte, error) {
...
func (o GitConnectorStatus) ToMap() (map[string]interface{}, error) {
...
func (o *GitConnectorStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varGitConnectorStatus := _GitConnectorStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGitConnectorStatus)

	if err != nil {
		return err
	}

	*o = GitConnectorStatus(varGitConnectorStatus)

	return err
}

type NullableGitConnectorStatus struct {
	value *GitConnectorStatus
	isSet bool
}

func (v NullableGitConnectorStatus) Get() *GitConnectorStatus {
	return v.value
}

func (v *NullableGitConnectorStatus) Set(val *GitConnectorStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableGitConnectorStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableGitConnectorStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGitConnectorStatus(val *GitConnectorStatus) *NullableGitConnectorStatus {
	return &NullableGitConnectorStatus{value: val, isSet: true}
}

func (v NullableGitConnectorStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGitConnectorStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
