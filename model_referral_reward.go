...
// checks if the ReferralReward type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReferralReward{}

// ReferralReward struct for ReferralReward
...
// NewReferralReward instantiates a new ReferralReward object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewReferralReward() *ReferralReward {
	this := ReferralReward{}
	return &this
}

// NewReferralRewardWithDefaults instantiates a new ReferralReward object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewReferralRewardWithDefaults() *ReferralReward {
	this := ReferralReward{}
	return &this
}

// GetReferralCode returns the ReferralCode field value if set, zero value otherwise.
func (o *ReferralReward) GetReferralCode() string {
...
func (o *ReferralReward) GetReferralCodeOk() (*string, bool) {
	if o == nil || IsNil(o.ReferralCode) {
		return nil, false
	}
...
func (o *ReferralReward) HasReferralCode() bool {
	if o != nil && !IsNil(o.ReferralCode) {
		return true
	}
...
func (o *ReferralReward) SetReferralCode(v string) {
	o.ReferralCode = &v
}

// GetReferrerOrgId returns the ReferrerOrgId field value if set, zero value otherwise.
func (o *ReferralReward) GetReferrerOrgId() string {
...
// and a boolean to check if the value has been set.
func (o *ReferralReward) GetReferrerOrgIdOk() (*string, bool) {
	if o == nil || IsNil(o.ReferrerOrgId) {
		return nil, false
	}
...
func (o *ReferralReward) HasReferrerOrgId() bool {
	if o != nil && !IsNil(o.ReferrerOrgId) {
		return true
	}
...
func (o *ReferralReward) SetReferrerOrgId(v string) {
	o.ReferrerOrgId = &v
}

// GetRefereeEmail returns the RefereeEmail field value if set, zero value otherwise.
func (o *ReferralReward) GetRefereeEmail() string {
...
// and a boolean to check if the value has been set.
func (o *ReferralReward) GetRefereeEmailOk() (*string, bool) {
	if o == nil || IsNil(o.RefereeEmail) {
		return nil, false
	}
...
func (o *ReferralReward) HasRefereeEmail() bool {
	if o != nil && !IsNil(o.RefereeEmail) {
		return true
	}
...
func (o *ReferralReward) SetRefereeEmail(v string) {
	o.RefereeEmail = &v
}

// GetRewardType returns the RewardType field value if set, zero value otherwise.
func (o *ReferralReward) GetRewardType() string {
...
// and a boolean to check if the value has been set.
func (o *ReferralReward) GetRewardTypeOk() (*string, bool) {
	if o == nil || IsNil(o.RewardType) {
		return nil, false
	}
...
func (o *ReferralReward) HasRewardType() bool {
	if o != nil && !IsNil(o.RewardType) {
		return true
	}
...
func (o *ReferralReward) SetRewardType(v string) {
	o.RewardType = &v
}

// GetRewardValue returns the RewardValue field value if set, zero value otherwise.
func (o *ReferralReward) GetRewardValue() float32 {
...
// and a boolean to check if the value has been set.
func (o *ReferralReward) GetRewardValueOk() (*float32, bool) {
	if o == nil || IsNil(o.RewardValue) {
		return nil, false
	}
...
func (o *ReferralReward) HasRewardValue() bool {
	if o != nil && !IsNil(o.RewardValue) {
		return true
	}
...
func (o *ReferralReward) SetRewardValue(v float32) {
	o.RewardValue = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *ReferralReward) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *ReferralReward) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *ReferralReward) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *ReferralReward) SetStatus(v string) {
	o.Status = &v
}

// GetAppliedAt returns the AppliedAt field value if set, zero value otherwise.
func (o *ReferralReward) GetAppliedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ReferralReward) GetAppliedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.AppliedAt) {
		return nil, false
	}
...
func (o *ReferralReward) HasAppliedAt() bool {
	if o != nil && !IsNil(o.AppliedAt) {
		return true
	}
...
func (o *ReferralReward) SetAppliedAt(v time.Time) {
	o.AppliedAt = &v
}

// GetExpiresAt returns the ExpiresAt field value if set, zero value otherwise.
func (o *ReferralReward) GetExpiresAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ReferralReward) GetExpiresAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.ExpiresAt) {
		return nil, false
	}
...
func (o *ReferralReward) HasExpiresAt() bool {
	if o != nil && !IsNil(o.ExpiresAt) {
		return true
	}
...
func (o *ReferralReward) SetExpiresAt(v time.Time) {
	o.ExpiresAt = &v
}

func (o ReferralReward) MarshalJSON() ([]byte, error) {
...
func (o ReferralReward) ToMap() (map[string]interface{}, error) {
...
type NullableReferralReward struct {
	value *ReferralReward
	isSet bool
}

func (v NullableReferralReward) Get() *ReferralReward {
	return v.value
}

func (v *NullableReferralReward) Set(val *ReferralReward) {
	v.value = val
	v.isSet = true
}

func (v NullableReferralReward) IsSet() bool {
	return v.isSet
}

func (v *NullableReferralReward) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReferralReward(val *ReferralReward) *NullableReferralReward {
	return &NullableReferralReward{value: val, isSet: true}
}

func (v NullableReferralReward) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReferralReward) UnmarshalJSON(src []byte) error {
	v.isSet = true
