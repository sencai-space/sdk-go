...
// checks if the CreateAgentUpdatePolicyRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAgentUpdatePolicyRequestData{}

// CreateAgentUpdatePolicyRequestData struct for CreateAgentUpdatePolicyRequestData
type CreateAgentUpdatePolicyRequestData struct {
...
type _CreateAgentUpdatePolicyRequestData CreateAgentUpdatePolicyRequestData

// NewCreateAgentUpdatePolicyRequestData instantiates a new CreateAgentUpdatePolicyRequestData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateAgentUpdatePolicyRequestData(version string) *CreateAgentUpdatePolicyRequestData {
	this := CreateAgentUpdatePolicyRequestData{}
	this.Version = version
	return &this
}

// NewCreateAgentUpdatePolicyRequestDataWithDefaults instantiates a new CreateAgentUpdatePolicyRequestData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCreateAgentUpdatePolicyRequestDataWithDefaults() *CreateAgentUpdatePolicyRequestData {
	this := CreateAgentUpdatePolicyRequestData{}
	return &this
}

// GetVersion returns the Version field value
func (o *CreateAgentUpdatePolicyRequestData) GetVersion() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CreateAgentUpdatePolicyRequestData) GetVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetVersion(v string) {
	o.Version = v
}

// GetBinaryUrl returns the BinaryUrl field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetBinaryUrl() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetBinaryUrlOk() (*string, bool) {
	if o == nil || IsNil(o.BinaryUrl) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasBinaryUrl() bool {
	if o != nil && !IsNil(o.BinaryUrl) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetBinaryUrl(v string) {
	o.BinaryUrl = &v
}

// GetBinarySha256 returns the BinarySha256 field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetBinarySha256() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetBinarySha256Ok() (*string, bool) {
	if o == nil || IsNil(o.BinarySha256) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasBinarySha256() bool {
	if o != nil && !IsNil(o.BinarySha256) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetBinarySha256(v string) {
	o.BinarySha256 = &v
}

// GetCosignSignature returns the CosignSignature field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetCosignSignature() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetCosignSignatureOk() (*string, bool) {
	if o == nil || IsNil(o.CosignSignature) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasCosignSignature() bool {
	if o != nil && !IsNil(o.CosignSignature) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetCosignSignature(v string) {
	o.CosignSignature = &v
}

// GetSbomUrl returns the SbomUrl field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetSbomUrl() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetSbomUrlOk() (*string, bool) {
	if o == nil || IsNil(o.SbomUrl) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasSbomUrl() bool {
	if o != nil && !IsNil(o.SbomUrl) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetSbomUrl(v string) {
	o.SbomUrl = &v
}
...
func (o *CreateAgentUpdatePolicyRequestData) HasStagedRollout() bool {
	if o != nil && !IsNil(o.StagedRollout) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) GetCurrentRing() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetCurrentRingOk() (*string, bool) {
	if o == nil || IsNil(o.CurrentRing) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasCurrentRing() bool {
	if o != nil && !IsNil(o.CurrentRing) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetCurrentRing(v string) {
	o.CurrentRing = &v
}

// GetHealthcheckFailures returns the HealthcheckFailures field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetHealthcheckFailures() int32 {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetHealthcheckFailuresOk() (*int32, bool) {
	if o == nil || IsNil(o.HealthcheckFailures) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasHealthcheckFailures() bool {
	if o != nil && !IsNil(o.HealthcheckFailures) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetHealthcheckFailures(v int32) {
	o.HealthcheckFailures = &v
}

// GetAutoPauseThreshold returns the AutoPauseThreshold field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetAutoPauseThreshold() int32 {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetAutoPauseThresholdOk() (*int32, bool) {
	if o == nil || IsNil(o.AutoPauseThreshold) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasAutoPauseThreshold() bool {
	if o != nil && !IsNil(o.AutoPauseThreshold) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetAutoPauseThreshold(v int32) {
	o.AutoPauseThreshold = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetStatus(v string) {
	o.Status = &v
}

// GetReleaseNotes returns the ReleaseNotes field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetReleaseNotes() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetReleaseNotesOk() (*string, bool) {
	if o == nil || IsNil(o.ReleaseNotes) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasReleaseNotes() bool {
	if o != nil && !IsNil(o.ReleaseNotes) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetReleaseNotes(v string) {
	o.ReleaseNotes = &v
}

// GetIsSecurityPatch returns the IsSecurityPatch field value if set, zero value otherwise.
func (o *CreateAgentUpdatePolicyRequestData) GetIsSecurityPatch() bool {
...
// and a boolean to check if the value has been set.
func (o *CreateAgentUpdatePolicyRequestData) GetIsSecurityPatchOk() (*bool, bool) {
	if o == nil || IsNil(o.IsSecurityPatch) {
		return nil, false
	}
...
func (o *CreateAgentUpdatePolicyRequestData) HasIsSecurityPatch() bool {
	if o != nil && !IsNil(o.IsSecurityPatch) {
		return true
	}
...
func (o *CreateAgentUpdatePolicyRequestData) SetIsSecurityPatch(v bool) {
	o.IsSecurityPatch = &v
}

func (o CreateAgentUpdatePolicyRequestData) MarshalJSON() ([]byte, error) {
...
func (o CreateAgentUpdatePolicyRequestData) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAgentUpdatePolicyRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAgentUpdatePolicyRequestData := _CreateAgentUpdatePolicyRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAgentUpdatePolicyRequestData)

	if err != nil {
		return err
	}

	*o = CreateAgentUpdatePolicyRequestData(varCreateAgentUpdatePolicyRequestData)

	return err
}

type NullableCreateAgentUpdatePolicyRequestData struct {
	value *CreateAgentUpdatePolicyRequestData
	isSet bool
}

func (v NullableCreateAgentUpdatePolicyRequestData) Get() *CreateAgentUpdatePolicyRequestData {
	return v.value
}

func (v *NullableCreateAgentUpdatePolicyRequestData) Set(val *CreateAgentUpdatePolicyRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAgentUpdatePolicyRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAgentUpdatePolicyRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAgentUpdatePolicyRequestData(val *CreateAgentUpdatePolicyRequestData) *NullableCreateAgentUpdatePolicyRequestData {
	return &NullableCreateAgentUpdatePolicyRequestData{value: val, isSet: true}
}

func (v NullableCreateAgentUpdatePolicyRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAgentUpdatePolicyRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
