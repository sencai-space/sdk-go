...
func NewSubscriptionTier(name string, slug string) *SubscriptionTier {
...
func (o *SubscriptionTier) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *SubscriptionTier) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *SubscriptionTier) SetName(v string) {
	o.Name = v
}

// GetSlug returns the Slug field value
func (o *SubscriptionTier) GetSlug() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetSlugOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Slug, true
...
func (o *SubscriptionTier) SetSlug(v string) {
	o.Slug = v
}

// GetMaxManagedHosts returns the MaxManagedHosts field value if set, zero value otherwise.
func (o *SubscriptionTier) GetMaxManagedHosts() int32 {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetMaxManagedHostsOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxManagedHosts) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasMaxManagedHosts() bool {
	if o != nil && !IsNil(o.MaxManagedHosts) {
		return true
	}
...
func (o *SubscriptionTier) SetMaxManagedHosts(v int32) {
	o.MaxManagedHosts = &v
}

// GetMaxOrganisations returns the MaxOrganisations field value if set, zero value otherwise.
func (o *SubscriptionTier) GetMaxOrganisations() int32 {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetMaxOrganisationsOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxOrganisations) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasMaxOrganisations() bool {
	if o != nil && !IsNil(o.MaxOrganisations) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetMaxCloudInstancesOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxCloudInstances) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasMaxCloudInstances() bool {
	if o != nil && !IsNil(o.MaxCloudInstances) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetPriceMonthlyUsdOk() (*float32, bool) {
	if o == nil || IsNil(o.PriceMonthlyUsd) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasPriceMonthlyUsd() bool {
	if o != nil && !IsNil(o.PriceMonthlyUsd) {
		return true
	}
...
func (o *SubscriptionTier) SetPriceMonthlyUsd(v float32) {
	o.PriceMonthlyUsd = &v
}

// GetPriceYearlyUsd returns the PriceYearlyUsd field value if set, zero value otherwise.
func (o *SubscriptionTier) GetPriceYearlyUsd() float32 {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetPriceYearlyUsdOk() (*float32, bool) {
	if o == nil || IsNil(o.PriceYearlyUsd) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasPriceYearlyUsd() bool {
	if o != nil && !IsNil(o.PriceYearlyUsd) {
		return true
	}
...
func (o *SubscriptionTier) SetPriceYearlyUsd(v float32) {
	o.PriceYearlyUsd = &v
}
...
func (o *SubscriptionTier) HasFeatures() bool {
	if o != nil && !IsNil(o.Features) {
		return true
	}
...
func (o *SubscriptionTier) GetIsFreeTier() bool {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetIsFreeTierOk() (*bool, bool) {
	if o == nil || IsNil(o.IsFreeTier) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasIsFreeTier() bool {
	if o != nil && !IsNil(o.IsFreeTier) {
		return true
	}
...
func (o *SubscriptionTier) SetIsFreeTier(v bool) {
	o.IsFreeTier = &v
}

// GetIsActive returns the IsActive field value if set, zero value otherwise.
func (o *SubscriptionTier) GetIsActive() bool {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetIsActiveOk() (*bool, bool) {
	if o == nil || IsNil(o.IsActive) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasIsActive() bool {
	if o != nil && !IsNil(o.IsActive) {
		return true
	}
...
func (o *SubscriptionTier) SetIsActive(v bool) {
	o.IsActive = &v
}

// GetTrialDays returns the TrialDays field value if set, zero value otherwise.
func (o *SubscriptionTier) GetTrialDays() int32 {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetTrialDaysOk() (*int32, bool) {
	if o == nil || IsNil(o.TrialDays) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasTrialDays() bool {
	if o != nil && !IsNil(o.TrialDays) {
		return true
	}
...
func (o *SubscriptionTier) SetTrialDays(v int32) {
	o.TrialDays = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *SubscriptionTier) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *SubscriptionTier) SetStatus(v string) {
	o.Status = &v
}

// GetActivatedAt returns the ActivatedAt field value if set, zero value otherwise.
func (o *SubscriptionTier) GetActivatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetActivatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.ActivatedAt) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasActivatedAt() bool {
	if o != nil && !IsNil(o.ActivatedAt) {
		return true
	}
...
func (o *SubscriptionTier) SetActivatedAt(v time.Time) {
	o.ActivatedAt = &v
}

// GetGraceExpiresAt returns the GraceExpiresAt field value if set, zero value otherwise.
func (o *SubscriptionTier) GetGraceExpiresAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetGraceExpiresAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.GraceExpiresAt) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasGraceExpiresAt() bool {
	if o != nil && !IsNil(o.GraceExpiresAt) {
		return true
	}
...
func (o *SubscriptionTier) SetGraceExpiresAt(v time.Time) {
	o.GraceExpiresAt = &v
}

// GetSuspendedAt returns the SuspendedAt field value if set, zero value otherwise.
func (o *SubscriptionTier) GetSuspendedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *SubscriptionTier) GetSuspendedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.SuspendedAt) {
		return nil, false
	}
...
func (o *SubscriptionTier) HasSuspendedAt() bool {
	if o != nil && !IsNil(o.SuspendedAt) {
		return true
	}
...
func (o *SubscriptionTier) SetSuspendedAt(v time.Time) {
	o.SuspendedAt = &v
}
...
func (o *SubscriptionTier) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varSubscriptionTier)
