...
// checks if the CreateSpendCapRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSpendCapRequestData{}

// CreateSpendCapRequestData struct for CreateSpendCapRequestData
type CreateSpendCapRequestData struct {
...
type _CreateSpendCapRequestData CreateSpendCapRequestData

// NewCreateSpendCapRequestData instantiates a new CreateSpendCapRequestData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateSpendCapRequestData(organisation CreateAccessReviewRequestDataReviewer, softCapEur float32, hardCapEur float32) *CreateSpendCapRequestData {
	this := CreateSpendCapRequestData{}
...
// NewCreateSpendCapRequestDataWithDefaults instantiates a new CreateSpendCapRequestData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCreateSpendCapRequestDataWithDefaults() *CreateSpendCapRequestData {
	this := CreateSpendCapRequestData{}
	return &this
}

// GetOrganisation returns the Organisation field value
func (o *CreateSpendCapRequestData) GetOrganisation() CreateAccessReviewRequestDataReviewer {
	if o == nil {
...
func (o *CreateSpendCapRequestData) GetOrganisationOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) SetOrganisation(v CreateAccessReviewRequestDataReviewer) {
	o.Organisation = v
}

// GetSoftCapEur returns the SoftCapEur field value
func (o *CreateSpendCapRequestData) GetSoftCapEur() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetSoftCapEurOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) SetSoftCapEur(v float32) {
	o.SoftCapEur = v
}

// GetHardCapEur returns the HardCapEur field value
func (o *CreateSpendCapRequestData) GetHardCapEur() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetHardCapEurOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) SetHardCapEur(v float32) {
	o.HardCapEur = v
}

// GetCurrentPeriodSpend returns the CurrentPeriodSpend field value if set, zero value otherwise.
func (o *CreateSpendCapRequestData) GetCurrentPeriodSpend() float32 {
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetCurrentPeriodSpendOk() (*float32, bool) {
	if o == nil || IsNil(o.CurrentPeriodSpend) {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) HasCurrentPeriodSpend() bool {
	if o != nil && !IsNil(o.CurrentPeriodSpend) {
		return true
	}
...
func (o *CreateSpendCapRequestData) SetCurrentPeriodSpend(v float32) {
	o.CurrentPeriodSpend = &v
}

// GetPeriodStart returns the PeriodStart field value if set, zero value otherwise.
func (o *CreateSpendCapRequestData) GetPeriodStart() time.Time {
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetPeriodStartOk() (*time.Time, bool) {
	if o == nil || IsNil(o.PeriodStart) {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) HasPeriodStart() bool {
	if o != nil && !IsNil(o.PeriodStart) {
		return true
	}
...
func (o *CreateSpendCapRequestData) SetPeriodStart(v time.Time) {
	o.PeriodStart = &v
}

// GetPeriodEnd returns the PeriodEnd field value if set, zero value otherwise.
func (o *CreateSpendCapRequestData) GetPeriodEnd() time.Time {
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetPeriodEndOk() (*time.Time, bool) {
	if o == nil || IsNil(o.PeriodEnd) {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) HasPeriodEnd() bool {
	if o != nil && !IsNil(o.PeriodEnd) {
		return true
	}
...
func (o *CreateSpendCapRequestData) SetPeriodEnd(v time.Time) {
	o.PeriodEnd = &v
}

// GetIsActive returns the IsActive field value if set, zero value otherwise.
func (o *CreateSpendCapRequestData) GetIsActive() bool {
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetIsActiveOk() (*bool, bool) {
	if o == nil || IsNil(o.IsActive) {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) HasIsActive() bool {
	if o != nil && !IsNil(o.IsActive) {
		return true
	}
...
func (o *CreateSpendCapRequestData) SetIsActive(v bool) {
	o.IsActive = &v
}

// GetLastAlertAt returns the LastAlertAt field value if set, zero value otherwise.
func (o *CreateSpendCapRequestData) GetLastAlertAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetLastAlertAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastAlertAt) {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) HasLastAlertAt() bool {
	if o != nil && !IsNil(o.LastAlertAt) {
		return true
	}
...
func (o *CreateSpendCapRequestData) SetLastAlertAt(v time.Time) {
	o.LastAlertAt = &v
}

// GetNotificationsEmail returns the NotificationsEmail field value if set, zero value otherwise.
func (o *CreateSpendCapRequestData) GetNotificationsEmail() string {
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetNotificationsEmailOk() (*string, bool) {
	if o == nil || IsNil(o.NotificationsEmail) {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) HasNotificationsEmail() bool {
	if o != nil && !IsNil(o.NotificationsEmail) {
		return true
	}
...
func (o *CreateSpendCapRequestData) SetNotificationsEmail(v string) {
	o.NotificationsEmail = &v
}

// GetSafetyOverrideCount returns the SafetyOverrideCount field value if set, zero value otherwise.
func (o *CreateSpendCapRequestData) GetSafetyOverrideCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *CreateSpendCapRequestData) GetSafetyOverrideCountOk() (*int32, bool) {
	if o == nil || IsNil(o.SafetyOverrideCount) {
		return nil, false
	}
...
func (o *CreateSpendCapRequestData) HasSafetyOverrideCount() bool {
	if o != nil && !IsNil(o.SafetyOverrideCount) {
		return true
	}
...
func (o *CreateSpendCapRequestData) SetSafetyOverrideCount(v int32) {
	o.SafetyOverrideCount = &v
}

func (o CreateSpendCapRequestData) MarshalJSON() ([]byte, error) {
...
func (o CreateSpendCapRequestData) ToMap() (map[string]interface{}, error) {
...
func (o *CreateSpendCapRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateSpendCapRequestData := _CreateSpendCapRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateSpendCapRequestData)

	if err != nil {
		return err
	}

	*o = CreateSpendCapRequestData(varCreateSpendCapRequestData)

	return err
}

type NullableCreateSpendCapRequestData struct {
	value *CreateSpendCapRequestData
	isSet bool
}

func (v NullableCreateSpendCapRequestData) Get() *CreateSpendCapRequestData {
	return v.value
}

func (v *NullableCreateSpendCapRequestData) Set(val *CreateSpendCapRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSpendCapRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSpendCapRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSpendCapRequestData(val *CreateSpendCapRequestData) *NullableCreateSpendCapRequestData {
	return &NullableCreateSpendCapRequestData{value: val, isSet: true}
}

func (v NullableCreateSpendCapRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSpendCapRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
