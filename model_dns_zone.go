...
func NewDnsZone(provider string, name string, providerZoneId string) *DnsZone {
	this := DnsZone{}
...
func (o *DnsZone) GetProvider() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *DnsZone) GetProviderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DnsZone) SetProvider(v string) {
	o.Provider = v
}
...
// and a boolean to check if the value has been set.
func (o *DnsZone) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *DnsZone) SetType(v string) {
	o.Type = &v
}

// GetProviderZoneId returns the ProviderZoneId field value
func (o *DnsZone) GetProviderZoneId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DnsZone) GetProviderZoneIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *DnsZone) GetRecordsCountOk() (*int32, bool) {
	if o == nil || IsNil(o.RecordsCount) {
		return nil, false
	}
...
func (o *DnsZone) HasRecordsCount() bool {
	if o != nil && !IsNil(o.RecordsCount) {
		return true
	}
...
func (o *DnsZone) SetRecordsCount(v int32) {
	o.RecordsCount = &v
}
...
func (o *DnsZone) GetOrganisation() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *DnsZone) GetOrganisationOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.Organisation) {
		return nil, false
	}
...
func (o *DnsZone) HasOrganisation() bool {
	if o != nil && !IsNil(o.Organisation) {
		return true
	}
...
func (o *DnsZone) SetOrganisation(v CreateAccessReviewRequestDataReviewer) {
	o.Organisation = &v
}

// GetCredential returns the Credential field value if set, zero value otherwise.
func (o *DnsZone) GetCredential() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *DnsZone) GetCredentialOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.Credential) {
		return nil, false
	}
...
func (o *DnsZone) HasCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *DnsZone) SetCredential(v CreateAccessReviewRequestDataReviewer) {
	o.Credential = &v
}
...
func (o *DnsZone) HasProviderMetadata() bool {
	if o != nil && !IsNil(o.ProviderMetadata) {
		return true
	}
