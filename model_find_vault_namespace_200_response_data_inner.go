...
var _ MappedNullable = &FindVaultNamespace200ResponseDataInner{}
...
// NewFindVaultNamespace200ResponseDataInnerWithDefaults instantiates a new FindVaultNamespace200ResponseDataInner object
...
func (o *FindVaultNamespace200ResponseDataInner) GetDocumentId() string {
...
// and a boolean to check if the value has been set.
func (o *FindVaultNamespace200ResponseDataInner) GetDocumentIdOk() (*string, bool) {
	if o == nil || IsNil(o.DocumentId) {
		return nil, false
	}
...
func (o *FindVaultNamespace200ResponseDataInner) HasDocumentId() bool {
	if o != nil && !IsNil(o.DocumentId) {
		return true
	}
...
func (o *FindVaultNamespace200ResponseDataInner) SetDocumentId(v string) {
	o.DocumentId = &v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *FindVaultNamespace200ResponseDataInner) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FindVaultNamespace200ResponseDataInner) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *FindVaultNamespace200ResponseDataInner) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *FindVaultNamespace200ResponseDataInner) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *FindVaultNamespace200ResponseDataInner) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *FindVaultNamespace200ResponseDataInner) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *FindVaultNamespace200ResponseDataInner) SetCreatedAt(v time.Time) {
	o.CreatedAt = &v
}

// GetUpdatedAt returns the UpdatedAt field value if set, zero value otherwise.
func (o *FindVaultNamespace200ResponseDataInner) GetUpdatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *FindVaultNamespace200ResponseDataInner) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.UpdatedAt) {
		return nil, false
	}
...
func (o *FindVaultNamespace200ResponseDataInner) HasUpdatedAt() bool {
	if o != nil && !IsNil(o.UpdatedAt) {
		return true
	}
...
func (o *FindVaultNamespace200ResponseDataInner) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = &v
}

// GetPublishedAt returns the PublishedAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *FindVaultNamespace200ResponseDataInner) GetPublishedAt() time.Time {
...
func (o *FindVaultNamespace200ResponseDataInner) GetPublishedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *FindVaultNamespace200ResponseDataInner) HasPublishedAt() bool {
...
func (o *FindVaultNamespace200ResponseDataInner) SetPublishedAt(v time.Time) {
	o.PublishedAt.Set(&v)
}
// SetPublishedAtNil sets the value for PublishedAt to be an explicit nil
func (o *FindVaultNamespace200ResponseDataInner) SetPublishedAtNil() {
	o.PublishedAt.Set(nil)
}

// UnsetPublishedAt ensures that no value is present for PublishedAt, not even an explicit nil
func (o *FindVaultNamespace200ResponseDataInner) UnsetPublishedAt() {
	o.PublishedAt.Unset()
}

func (o FindVaultNamespace200ResponseDataInner) MarshalJSON() ([]byte, error) {
...
type NullableFindVaultNamespace200ResponseDataInner struct {
	value *FindVaultNamespace200ResponseDataInner
	isSet bool
}

func (v NullableFindVaultNamespace200ResponseDataInner) Get() *FindVaultNamespace200ResponseDataInner {
	return v.value
}

func (v *NullableFindVaultNamespace200ResponseDataInner) Set(val *FindVaultNamespace200ResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFindVaultNamespace200ResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFindVaultNamespace200ResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindVaultNamespace200ResponseDataInner(val *FindVaultNamespace200ResponseDataInner) *NullableFindVaultNamespace200ResponseDataInner {
	return &NullableFindVaultNamespace200ResponseDataInner{value: val, isSet: true}
}

func (v NullableFindVaultNamespace200ResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindVaultNamespace200ResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
