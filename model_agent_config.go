...
func NewAgentConfig(configKey string) *AgentConfig {
	this := AgentConfig{}
...
func (o *AgentConfig) GetConfigKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AgentConfig) GetConfigKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AgentConfig) SetConfigKey(v string) {
	o.ConfigKey = v
}

// GetConfigValue returns the ConfigValue field value if set, zero value otherwise.
func (o *AgentConfig) GetConfigValue() string {
...
// and a boolean to check if the value has been set.
func (o *AgentConfig) GetConfigValueOk() (*string, bool) {
	if o == nil || IsNil(o.ConfigValue) {
		return nil, false
	}
...
func (o *AgentConfig) HasConfigValue() bool {
	if o != nil && !IsNil(o.ConfigValue) {
		return true
	}
...
func (o *AgentConfig) SetConfigValue(v string) {
	o.ConfigValue = &v
}

// GetConfigType returns the ConfigType field value if set, zero value otherwise.
func (o *AgentConfig) GetConfigType() string {
...
// and a boolean to check if the value has been set.
func (o *AgentConfig) GetConfigTypeOk() (*string, bool) {
	if o == nil || IsNil(o.ConfigType) {
		return nil, false
	}
...
func (o *AgentConfig) HasConfigType() bool {
	if o != nil && !IsNil(o.ConfigType) {
		return true
	}
...
func (o *AgentConfig) SetConfigType(v string) {
	o.ConfigType = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *AgentConfig) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *AgentConfig) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *AgentConfig) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *AgentConfig) SetDescription(v string) {
	o.Description = &v
}

// GetAppliesTo returns the AppliesTo field value if set, zero value otherwise.
func (o *AgentConfig) GetAppliesTo() string {
...
// and a boolean to check if the value has been set.
func (o *AgentConfig) GetAppliesToOk() (*string, bool) {
	if o == nil || IsNil(o.AppliesTo) {
		return nil, false
	}
...
func (o *AgentConfig) HasAppliesTo() bool {
	if o != nil && !IsNil(o.AppliesTo) {
		return true
	}
...
func (o *AgentConfig) SetAppliesTo(v string) {
	o.AppliesTo = &v
}

// GetAgentId returns the AgentId field value if set, zero value otherwise.
func (o *AgentConfig) GetAgentId() string {
...
// and a boolean to check if the value has been set.
func (o *AgentConfig) GetAgentIdOk() (*string, bool) {
	if o == nil || IsNil(o.AgentId) {
		return nil, false
	}
...
func (o *AgentConfig) HasAgentId() bool {
	if o != nil && !IsNil(o.AgentId) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *AgentConfig) GetIsSensitiveOk() (*bool, bool) {
	if o == nil || IsNil(o.IsSensitive) {
		return nil, false
	}
...
func (o *AgentConfig) HasIsSensitive() bool {
	if o != nil && !IsNil(o.IsSensitive) {
		return true
	}
...
func (o *AgentConfig) SetIsSensitive(v bool) {
	o.IsSensitive = &v
}

// GetOrganisation returns the Organisation field value if set, zero value otherwise.
func (o *AgentConfig) GetOrganisation() CreateAccessReviewRequestDataReviewer {
...
// and a boolean to check if the value has been set.
func (o *AgentConfig) GetOrganisationOk() (*CreateAccessReviewRequestDataReviewer, bool) {
	if o == nil || IsNil(o.Organisation) {
		return nil, false
	}
...
func (o *AgentConfig) HasOrganisation() bool {
	if o != nil && !IsNil(o.Organisation) {
		return true
	}
...
func (o *AgentConfig) SetOrganisation(v CreateAccessReviewRequestDataReviewer) {
	o.Organisation = &v
}
