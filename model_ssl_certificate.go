...
func (o *SslCertificate) GetSubjectAltNames() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *SslCertificate) GetSubjectAltNamesOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.SubjectAltNames) {
...
func (o *SslCertificate) SetSubjectAltNames(v map[string]interface{}) {
	o.SubjectAltNames = v
}
