...
func (o *AgentUpdatePolicy) GetStagedRollout() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *AgentUpdatePolicy) GetStagedRolloutOk() (*interface{}, bool) {
...
func (o *AgentUpdatePolicy) SetStagedRollout(v interface{}) {
	o.StagedRollout = v
}
